...
impl<'a> Machine<'a> {
  pub fn process_cycles(&mut self) {
    ...
    if cfg!(debug_assertions) {
      println!("{:>2x?}, pc: 0x{:0>4x}, a: 0x{:0>2x}, isrDelay: 0x{:0>2x}", ins, self.registers.pc, self.registers.a, self.memory[0x20c0]);
    }
    self.execute(&ins);
  }
  ...
  pub fn execute(&mut self, ins: &intel8080disassembler::Instruction) {
    match ins.opcode {
      ...
      0x02 => {
        self.memory[self.registers.get_rp(RegisterPairs::B) as usize] = self.registers.a;
        self.registers.pc += 1;
      },
      0x03 => {
        let result = self.registers.get_rp(RegisterPairs::B) as u32 + 1;
        self.registers.set_rp(RegisterPairs::B, (result & 0xffff) as u16);
        self.registers.pc += 1;
      },
      0x04 => {
      ...
      0x07 => {
        ...
        self.registers.a &= 0b01111111;
        self.registers.a = self.registers.a << 7;
        self.registers.a |= a0;
        self.registers.pc += 1;
      }
      0x09 => {
      ...
      0x0a => {
        self.registers.a = self.memory[self.registers.get_rp(RegisterPairs::B) as usize];
        self.registers.pc += 1;
      }
      0x0b => {
        let result = ((self.registers.get_rp(RegisterPairs::B) as u32) + 0x10000 - 1) & 0xffff;
        self.registers.set_rp(RegisterPairs::B, result as u16);
        self.registers.pc += 1;
      }
      0x0c => {
        // Not tested
      ...
      0x12 => {
        self.memory[self.registers.get_rp(RegisterPairs::D) as usize] = self.registers.a;
        self.registers.pc += 1;
      },
      0x1a => {
      ...
      0x1b => {
        let result = ((self.registers.get_rp(RegisterPairs::D) as u32) + 0x10000 - 1) & 0xffff;
        self.registers.set_rp(RegisterPairs::D, result as u16);
        self.registers.pc += 1;
      }
      0x1c => {
      ...
      0x22 => {
        ...
        self.memory[addr as usize + 1] = self.registers.h;
        self.registers.pc += 3;
      },
      0x23 => {
      ...
      0x2a => {
        let addr = ((ins.operand2 as usize) << 8) + ins.operand1 as usize;
      ...
      0x2b => {
        // Not tested
        let result = (self.registers.get_rp(RegisterPairs::H) as u32 + 0x10000) - 1;
        self.registers.set_rp(RegisterPairs::H, (result & 0xffff) as u16);
        self.registers.pc += 1;
      },
      0x2c => {
      ...
      0x34 => {
        // Not tested
        let result = (self.memory[self.registers.get_rp(RegisterPairs::H) as usize] as u16 + 1) & 0xff;
        self.memory[self.registers.get_rp(RegisterPairs::H) as usize] = result as u8;
        self.registers.set_flag(result as u16);
        self.registers.pc += 1;
      },
      0x35 => {
        // Not tested
        let result = (self.memory[self.registers.get_rp(RegisterPairs::H) as usize] as u16 + 0x100 - 1) & 0xff;
        self.memory[self.registers.get_rp(RegisterPairs::H) as usize] = result as u8;
      ...
      0x86 => {
        let result = (self.registers.a as u16) + (self.memory[self.registers.get_rp(RegisterPairs::H) as usize] as u16);
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      },
      ...
      0x88 => {
        // Not tested
        let result = (self.registers.a as u16) + (self.registers.b as u16) + (self.registers.flag & 0b1 ) as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      },
      0x89 => {
        // Not tested
        let result = (self.registers.a as u16) + (self.registers.c as u16) + (self.registers.flag & 0b1 ) as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      },
      0x8a => {
        // Not tested
        let result = (self.registers.a as u16) + (self.registers.d as u16) + (self.registers.flag & 0b1 ) as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      },
      0x8b => {
        // Not tested
        let result = (self.registers.a as u16) + (self.registers.e as u16) + (self.registers.flag & 0b1 ) as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      },
      0x8c => {
        // Not tested
        let result = (self.registers.a as u16) + (self.registers.h as u16) + (self.registers.flag & 0b1 ) as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      },
      0x8d => {
        // Not tested
        let result = (self.registers.a as u16) + (self.registers.l as u16) + (self.registers.flag & 0b1 ) as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      },
      0x8e => {
        // Not tested
        let result = (self.registers.a as u16) + (self.memory[self.registers.get_rp(RegisterPairs::H) as usize] as u16) + (self.registers.flag & 0b1 ) as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      },
      0x8f => {
        // Not tested
        let result = (self.registers.a as u16) + (self.registers.a as u16) + (self.registers.flag & 0b1 ) as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      },
      0x90 => {
        // Not tested
        let b = (!self.registers.b + 1) as u16;
        let result = (self.registers.a as u16) + b;
        self.registers.set_sub_flat(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      }
      0x91 => {
        let c = (!self.registers.c + 1) as u16;
        let result = (self.registers.a as u16) + c;
        self.registers.set_sub_flat(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      }
      0x92 => {
        let d = (!self.registers.d + 1) as u16;
        let result = (self.registers.a as u16) + d;
        self.registers.set_sub_flat(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      }
      0x93 => {
        let e = (!self.registers.e + 1) as u16;
        let result = (self.registers.a as u16) + e;
        self.registers.set_sub_flat(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      }
      0x94 => {
        let h = (!self.registers.h + 1) as u16;
        let result = (self.registers.a as u16) + h;
        self.registers.set_sub_flat(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      }
      0x95 => {
        let l = (!self.registers.l + 1) as u16;
        let result = (self.registers.a as u16) + l;
        self.registers.set_sub_flat(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      }
      0x96 => {
        let m = (!self.memory[self.registers.get_rp(RegisterPairs::H) as usize] + 1) as u16;
        let result = (self.registers.a as u16) + m;
        self.registers.set_sub_flat(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      }
      0x97 => {
        let a = (!self.registers.a + 1) as u16;
        let result = (self.registers.a as u16) + a;
        self.registers.set_sub_flat(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      }
      0x98 => {
        // Not tested
        let to_add = !((((self.registers.b) as u16 + (self.registers.flag & 0b1) as u16) & 0xff) as u8) + 1;
        let result = self.registers.a as u16 + to_add as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      },
      0x99 => {
        let to_add = !((((self.registers.c) as u16 + (self.registers.flag & 0b1) as u16) & 0xff) as u8) + 1;
        let result = self.registers.a as u16 + to_add as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      ...
      0x9a => {
        let to_add = !((((self.registers.d) as u16 + (self.registers.flag & 0b1) as u16) & 0xff) as u8) + 1;
        let result = self.registers.a as u16 + to_add as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      ...
      0x9c => {
        let to_add = !((((self.registers.h) as u16 + (self.registers.flag & 0b1) as u16) & 0xff) as u8) + 1;
        let result = self.registers.a as u16 + to_add as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      ...
      0x9d => {
        let to_add = !((((self.registers.l) as u16 + (self.registers.flag & 0b1) as u16) & 0xff) as u8) + 1;
        let result = self.registers.a as u16 + to_add as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      ...
      0x9e => {
        let to_add = !((((self.memory[self.registers.get_rp(RegisterPairs::H) as usize]) as u16 + (self.registers.flag & 0b1) as u16) & 0xff) as u8) + 1;
        let result = self.registers.a as u16 + to_add as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      ...
      0x9f => {
        let to_add = !((((self.registers.a) as u16 + (self.registers.flag & 0b1) as u16) & 0xff) as u8) + 1;
        let result = self.registers.a as u16 + to_add as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      ...
      0x9b => {
        let to_add = !((((self.registers.e) as u16 + (self.registers.flag & 0b1) as u16) & 0xff) as u8) + 1;
        let result = self.registers.a as u16 + to_add as u16;
        self.registers.set_flag(result);
        self.registers.a = (result & 0xff) as u8;
        self.registers.pc += 1;
      ...
      0xa6 => {
        let result = self.registers.a & self.memory[self.registers.get_rp(RegisterPairs::H) as usize];
        self.registers.a = result;
        self.registers.set_flag(result as u16);
        self.registers.pc += 1;
      },
      ...
      0xb8 => {
        let op = (!self.registers.b) as u16 + 1;
        let result = self.registers.a as u16 + op;
        self.registers.set_sub_flat(result);
        self.registers.pc += 1;
      },
      0xb9 => {
        let op = (!self.registers.c) as u16 + 1;
        let result = self.registers.a as u16 + op;
        self.registers.set_sub_flat(result);
        self.registers.pc += 1;
      },
      0xba => {
        let op = (!self.registers.d) as u16 + 1;
        let result = self.registers.a as u16 + op;
        self.registers.set_sub_flat(result);
        self.registers.pc += 1;
      },
      0xbb => {
        let op = (!self.registers.e) as u16 + 1;
        let result = self.registers.a as u16 + op;
        self.registers.set_sub_flat(result);
        self.registers.pc += 1;
      },
      0xbc => {
        let op = (!self.registers.h) as u16 + 1;
        let result = self.registers.a as u16 + op;
        self.registers.set_sub_flat(result);
        self.registers.pc += 1;
      },
      0xbd => {
        let op = (!self.registers.l) as u16 + 1;
        let result = self.registers.a as u16 + op;
        self.registers.set_sub_flat(result);
        self.registers.pc += 1;
      },
      0xbe => {
        let op = (!self.memory[self.registers.get_rp(RegisterPairs::H) as usize]) as u16 + 1;
        let result = self.registers.a as u16 + op;
        self.registers.set_sub_flat(result);
        self.registers.pc += 1;
      },
      0xbf => {
        let op = (!self.registers.a) as u16 + 1;
        let result = self.registers.a as u16 + op;
        self.registers.set_sub_flat(result);
        self.registers.pc += 1;
      },
      ...
      0xe3 => {
        ...
        self.registers.l = self.memory[self.registers.sp as usize];
        self.memory[self.registers.sp as usize] = l;
        let h = self.registers.h;
        self.registers.h = self.memory[self.registers.sp as usize + 1];
        self.memory[self.registers.sp as usize + 1] = h;
        self.registers.pc += 1;
      }
      0xe4 => {
        if self.registers.p() == 0 {
      ...
      0xe9 => {
        ...
        self.registers.pc = self.registers.get_rp(RegisterPairs::H);
        self.registers.set_rp(RegisterPairs::H, pc);
      },
      0xea => {
        if self.registers.p() == 1 {
          self.registers.pc = ((ins.operand2 as u16) << 8) + (ins.operand1 as u16);
...
mod tests {
  ...
  fn it_executes_0x22() {
    ...
    assert_eq!(machine.memory[0x1234], 0x56);
    assert_eq!(machine.memory[0x1234 + 1], 0x34);
  }
  ...
  fn it_executes_0x2a() {
    ...
    machine.execute(&operate);
    assert_eq!(machine.registers.pc, 3);
    assert_eq!(machine.registers.l, 0xab);
    assert_eq!(machine.registers.h, 0xcd);
  }
  ...
  fn it_executes_0x3f() {
    ...
    machine.registers.set_flag(0xffff);
    machine.execute(&operate);
    assert_eq!(machine.registers.c(), 0);
  ...
  fn it_executes_0xe3() {
    ...
    assert_eq!(machine.registers.l, 0xab);
    assert_eq!(machine.registers.h, 0xcd);
    assert_eq!(machine.memory[0xff], 0x34);
    assert_eq!(machine.memory[0xff + 1], 0x12);
    assert_eq!(machine.registers.pc, 1);
  }
